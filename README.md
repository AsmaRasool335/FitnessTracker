...
Build
bashg++ -o fitness_tracker main.cpp
Run
bash./fitness_tracker
...
6. Exit
Menu Options
OptionDescription1. Add UserCreate a new user profile (up to 10 users)2. Add WorkoutLog a workout for a selected user3. View WorkoutsDisplay all workouts and calorie progress for a user4. Delete UserRemove a user and their workout history5. Set Calorie GoalSet a daily/total calorie burn target for a user6. ExitQuit the application
...
Limits
ItemMaximumUsers10Workouts per user100Workout duration300 minutesCalories per workout5,000 kcalWorkout types (incl. custom)10
...
User (extends Person) — manages a collection of workouts and a calorie goal
